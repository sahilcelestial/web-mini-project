			...
			<center>
				<div style='background-color: #e6e6e6;' class='col-sm-3'>
					...
					<ul class='list-group'>
						...
						<li class='list-group-item' title='Gender'><strong>$gender</strong>		
						</li>
						<li class='list-group-item' title='Country'><strong>$user_country</strong>		
						</li>
						<li class='list-group-item' title='User Register Date'><strong>$register_date</strong>
						</li>
					</ul>
					";
